...
class BangkokPie extends StatefulWidget {
  const BangkokPie({Key? key}) : super(key: key);

  @override
  _BangkokPieState createState() => _BangkokPieState();
}

class _BangkokPieState extends State<BangkokPie> {
  Map<String, double> bangkokpie = {
