import 'package:dashbord/chart/chr_barchart.dart';
import 'package:dashbord/dialog/chr_showalertpayment.dart';
import 'package:dashbord/dialog/chr_showordercreated.dart';
import 'package:dashbord/pie/chonburi_pie.dart';
...
class Chonburi extends StatefulWidget {
  const Chonburi({Key? key}) : super(key: key);

  @override
  _ChonburiState createState() => _ChonburiState();
}

class _ChonburiState extends State<Chonburi> {
  @override
